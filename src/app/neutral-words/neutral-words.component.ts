...
ChkdeleteSelected(form:NgForm,neuscheme:Neutralscheme)
{

    this._tableservice.selectedneu = neuscheme;
    this.selectedNeutralRow = neuscheme;
    console.log(form.value,neuscheme);

      this._tableservice.neudelapproved({...form.value,...neuscheme}).subscribe((res) => {
         this.refreshEmployeeList();
...
ChkNotdeleteSelected(form:NgForm,neuscheme:Neutralscheme)
{
  ...
  this.selectedNeutralRow = neuscheme;
  console.log(form.value,neuscheme);
    this._tableservice.neudeldisapproved({...form.value,...neuscheme}).subscribe((res) => {
     this.refreshEmployeeList();
